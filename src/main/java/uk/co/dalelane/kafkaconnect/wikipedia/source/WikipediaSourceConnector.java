...
public class WikipediaSourceConnector extends SourceConnector {

    protected static final String VERSION = "0.0.1";

    private final Logger log = LoggerFactory.getLogger(WikipediaSourceConnector.class);
    ...
    public ConfigDef config() {
        return WikipediaConfig.CONFIG_DEF;
    }

    @Override
    public Class<? extends Task> taskClass() {
        return WikipediaSourceTask.class;
    }
